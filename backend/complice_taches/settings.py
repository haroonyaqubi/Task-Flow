...
SECRET_KEY = 'django-insecure-(nq9o52@z%0%s&dmv5ky&x#*f5$u*ts)y&+3hhl#y(6apt8_9k'
...
EMAIL_HOST_PASSWORD = 'fbgv fjun nngs ohwn'  # generate an app password if using Gmail
